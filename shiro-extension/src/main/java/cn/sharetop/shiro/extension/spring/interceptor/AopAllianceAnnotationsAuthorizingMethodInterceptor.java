...
public class AopAllianceAnnotationsAuthorizingMethodInterceptor extends
        org.apache.shiro.spring.security.interceptor.AopAllianceAnnotationsAuthorizingMethodInterceptor {

    public AopAllianceAnnotationsAuthorizingMethodInterceptor() {
        super();

        this.methodInterceptors.add(new ActionAnnotationMethodInterceptor(
                new SpringAnnotationResolver()));
        this.methodInterceptors.add(new DataAnnotationMethodInterceptor(
                new SpringAnnotationResolver()));
            ...
            for(AuthorizingAnnotationMethodInterceptor aami : aamis) {
                if(aami.supports(mi)) {
                    ...
                    if(aami instanceof DataAnnotationMethodInterceptor) {
                        return ((DataAnnotationMethodInterceptor) aami)
                                .invoke(mi);
                    }
